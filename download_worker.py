...
class DownloadWorker(AbstractWorker):
    ...
    def __init__(self,
        ...
        self.indices_string = indices_string
        self.load_geometries = load_geometries
        self.iso_codes_string = iso_codes_string

    def work(self):
        self.toggle_show_progress.emit(False)
        fname, msg = self.downloader.get_sv_data(
            self.indices_string, self.load_geometries, self.iso_codes_string)
