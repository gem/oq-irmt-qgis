...
# FIXME: let the branch be parametric
...
# docker exec -it qgis sh -c "git clone -q -b master --depth=1 https://github.com/gem/oq-engine.git && echo 'Running against oq-engine/master'"
