...
class SelectSvVariablesDialog(QDialog, FORM_CLASS):
    ...
    def __init__(self, downloader):
        ...
        self.vertical_layout.insertWidget(4, self.indicator_lbl)
        self.vertical_layout.insertWidget(5, self.indicator_multiselect)
        self.country_lbl = QLabel('Select Countries')
        self.country_multiselect = MultiSelectComboBox(self)
        self.vertical_layout.insertWidget(8, self.country_lbl)
        self.vertical_layout.insertWidget(9, self.country_multiselect)
