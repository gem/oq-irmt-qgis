...
from svir.dialogs.load_losses_by_event_as_layer_dialog import (
    LoadLossesByEventAsLayerDialog)
...
OUTPUT_TYPE_LOADERS = {
    ...
    'losses_by_event': LoadLossesByEventAsLayerDialog,
    'agg_loss_table': LoadLossesByEventAsLayerDialog,
}
