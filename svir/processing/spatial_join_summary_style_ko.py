...
# class SpatialJoinSummaryStyle(QgsProcessingAlgorithm):
    ...
    # initAlgorithm = SpatialJoinSummary.initAlgorithm
    # preProcessAlgorithm = SpatialJoinSummary.processAlgorithm
    ...
    #     output = self.preProcessAlgorithm(parameters, context, feedback)
