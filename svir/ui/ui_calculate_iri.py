...
#
# Created: Wed Apr 30 11:41:44 2014
...
class Ui_CalculateIRIDialog(object):
    def setupUi(self, CalculateIRIDialog):
        ...
        self.calculate_iri = QtGui.QGroupBox(CalculateIRIDialog)
        self.calculate_iri.setCheckable(True)
        self.calculate_iri.setChecked(False)
        self.calculate_iri.setObjectName(_fromUtf8("calculate_iri"))
        self.formLayout_2 = QtGui.QFormLayout(self.calculate_iri)
        self.formLayout_2.setObjectName(_fromUtf8("formLayout_2"))
        self.iri_combination_type = QtGui.QComboBox(self.calculate_iri)
    ...
    def retranslateUi(self, CalculateIRIDialog):
        ...
        self.calculate_iri.setTitle(_translate("CalculateIRIDialog", "IRI", None))
