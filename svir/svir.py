...
class Svir:
    ...
    def __init__(self, iface):
        ...
        localePath = os.path.join(self.plugin_dir, 'i18n', 'svir_{}.qm'.format(locale))
    ...
    def unload(self):
        ...
        self.iface.removePluginMenu(u"&OpenQuake Social Vulnerability and Integrated Risk", self.test_action)
