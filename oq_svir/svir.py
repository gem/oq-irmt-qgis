...
import oq_svir.resources_rc

from oq_svir.calculations.aggregate_loss_by_zone import (
    purge_zones_without_loss_points, calculate_zonal_stats)
from oq_svir.calculations.import_sv_data import get_loggedin_downloader
from oq_svir.dialogs.attribute_selection_dialog import AttributeSelectionDialog

from oq_svir.dialogs.download_layer_dialog import DownloadLayerDialog
from oq_svir.dialogs.projects_manager_dialog import ProjectsManagerDialog
from oq_svir.dialogs.select_input_layers_dialog import SelectInputLayersDialog
from oq_svir.dialogs.select_sv_variables_dialog import SelectSvVariablesDialog
from oq_svir.dialogs.settings_dialog import SettingsDialog
from oq_svir.dialogs.transformation_dialog import TransformationDialog
from oq_svir.dialogs.upload_settings_dialog import UploadSettingsDialog
from oq_svir.dialogs.weight_data_dialog import WeightDataDialog
from oq_svir.third_party.requests.sessions import Session
from oq_svir.thread_worker.abstract_worker import start_worker
from oq_svir.thread_worker.download_platform_data_worker import (
    DownloadPlatformDataWorker)
from oq_svir.thread_worker.download_platform_project_worker import (
    DownloadPlatformProjectWorker)
from oq_svir.metadata.metadata_utilities import write_iso_metadata_file
from oq_svir.dialogs.upload_dialog import UploadDialog
from oq_svir.calculations.calculate_utils import calculate_composite_variable
from oq_svir.calculations.process_layer import ProcessLayer
from oq_svir.utilities.utils import (tr,
                                     WaitCursorManager,
...
from oq_svir.utilities.shared import (
    SVIR_PLUGIN_VERSION,
