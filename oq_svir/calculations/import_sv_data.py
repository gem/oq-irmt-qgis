...
from oq_svir.third_party.requests import Session
from oq_svir.third_party.requests.exceptions import (ConnectionError,
                                             InvalidSchema,
                                             MissingSchema,
                                             ReadTimeout,
                                             )
from oq_svir.utilities.utils import (SvNetworkError,
                   platform_login,
                   get_credentials,
                   WaitCursorManager,
                   tr,
