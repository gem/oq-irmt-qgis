...
from oq_svir.thread_worker.upload_worker import UploadWorker
from oq_svir.third_party.requests.sessions import Session
from oq_svir.third_party.requests.utils import dict_from_cookiejar
from oq_svir.utilities.sldadapter import getGsCompatibleSld
from oq_svir.ui.ui_upload_metadata import Ui_UploadMetadataDialog
from oq_svir.utilities.utils import (get_credentials,
                   platform_login,
                   create_progress_message_bar, clear_progress_message_bar,
                   SvNetworkError)
from oq_svir.utilities.shared import DEBUG
