...
class WebSocket(QObject):
    ...
    def hyb_api_set(self, hyb_api):
        self.hyb_api = hyb_api
        hyb_api.ws_set(self)
    ...
    def handleMessage(self):
        ...
        """
        self.server.handle_socket_received(self.data, self.hyb_api)
    ...
    def sendMessage(self, data):
        ...
        print('before handle_socket_sent')
        self.server.handle_socket_sent(data, self.hyb_api)
