...
#
# Created: Tue Oct 22 16:22:49 2013
...
class Ui_HMTKWindow(object):
    def setupUi(self, HMTKWindow):
        ...
        self.catalogueTableView = CatalogueView(self.stackedFormWidgetPage7)
        ...
        self.actionLoadOSMBaseMap = QtGui.QAction(HMTKWindow)
        self.actionLoadOSMBaseMap.setCheckable(False)
        self.actionLoadOSMBaseMap.setObjectName(_fromUtf8("actionLoadOSMBaseMap"))
        self.menuLoad.addAction(self.actionLoadCatalogue)
        self.menuLoad.addAction(self.actionLoadSourceNRML)
        ...
        self.menuFile.addAction(self.actionLoadOSMBaseMap)
    ...
    def retranslateUi(self, HMTKWindow):
        ...
        self.menuLoad.setTitle(_translate("HMTKWindow", "Load", None))
        ...
        self.actionLoadOSMBaseMap.setText(_translate("HMTKWindow", "Load OSM base map", None))

from widgets import FigureCanvasQTAggWidget, ResultsTable, CatalogueView
